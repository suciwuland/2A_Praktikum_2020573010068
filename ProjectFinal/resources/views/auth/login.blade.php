...
<head>
    ...
    <title>Login Akun &mdash; MONEYYY</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/logo_money.gif') }}">
    <!-- General CSS Files -->
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <img src="{{ asset('assets/img/logo_money.gif') }}" alt="logo" width="100" class="shadow-light rounded-circle">
                    </div>
