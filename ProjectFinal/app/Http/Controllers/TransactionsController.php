...
class TransactionsController extends Controller
{
    ...
    public function store(CreateRequest $transactionCreateForm)
    {
        ...
        if ($transaction['in_out']) {
            Session::flash(__('transaction.income_added'), 'success');
        } else {
            Session::flash(__('transaction.spending_added'), 'success');
        }
    ...
    public function update(UpdateRequest $transactionUpateForm, Transaction $transaction)
    {
        ...
        Session::flash(__('transaction.updated'), 'success');
    ...
    public function destroy(Transaction $transaction)
    {
        ...
        if (request('transaction_id') == $transaction->id && $transaction->delete()) {
            Session::flash(__('transaction.deleted'), 'warning');
        ...
        Session::flash(__('transaction.undeleted'), 'error');
